...
describe('UniswapV3Factory', () => {
  ...
  async function createAndCheckPool(
    ...
    const create2Address = getCreate2Address(factory.address, tokens, feeAmount, poolBytecode) // 即 poolAddress, 对于新 tokens 的
